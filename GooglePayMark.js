...
function SvgComponent({ height, width, ...props }) {
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" viewBox="170 170 752 400" width={width ? width : height / 400 * 752} height={height ? height : width / 752 * 400} {...props}>
            <Path
                fill="#FFF"
